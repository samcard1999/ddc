...
document.querySelectorAll('.img-container').forEach((element, index) => {
        timeline.to(element, {
                scrollTrigger: {
                        ...
                        end: "800%", // Termina la animación después de 300px
                        //markers: true,
                        onUpdate: (self) => {   
                                console.log(`${document.querySelectorAll('.img-container').length*100}%`);
...
const handler = {
        set: function (target, property, value) {
                ...
                if (value !== bgImageTemp) {
                        changeImage(`../assets/Villa_Santa_Marta/1_${value}.jpg`);
                        bgImageTemp = value;
                }
